...
WHERE source_file IN ('SMWE-RULESET-1-EU883.md','SMWE-RULESET-2-PERMIT.md','SMWE-RULESET-3-DTA.md',
...
SELECT source_file, COUNT(*) AS total_chunks, SUM(reviewed) AS reviewed_chunks
FROM smwe_chunks GROUP BY source_file ORDER BY source_file;